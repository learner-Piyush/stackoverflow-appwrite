...
const Comments = ({
    ...
    comments: Models.DocumentList<Models.Document>, type: "question" | "answer", typeId: string, className?: string
}) => {
    ...
    const handleSubmit =async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response = await databases.createDocument(db, commentCollection, ID.unique(), {
                content: newComment, authorId: user.$id, type: type, typeId: typeId
            })
  ...
  return (
    <div className={cn("flex flex-col gap-2 pl-4", className)}>
        ...
        <form onSubmit={handleSubmit} className="flex items-center gap-2">
            ...
            rows={1} placeholder="Add a comment..." value={newComment}
